...
파일 확장자가 .md로 끝나는 것은 마크다운 문법으로 작성된 파일입니다.
사용법이 매우 쉽고, 쉽고 빠르게 문서를 작성할 수 있습니다.
...
`각각 <em>, <strong>, <del> 태그로 변환됩니다. 밑줄을 입력하고 싶다면 <u></u> 태그를 사용하세요.`
...
<br><br><br>
[이곳의 자료](https://heropy.blog/2017/09/30/markdown/)
